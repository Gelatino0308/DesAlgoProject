//loads and converts json file data to fareMatrix object 
...
function computeFair (firstFair, secondFair, originStation, destinationStation, currTotalFare, isDiscounted) {
...
function findAllRoutes(graph, origin, destination, typeOfRide, discount) {
...
//adjacency list of the station graph
